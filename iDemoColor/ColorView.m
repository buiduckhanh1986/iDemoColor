...
- (instancetype) initWithHex: (NSString*) hex
    ...
    self.backgroundColor = [[HexColor alloc] initWithHex:hex
                                                  alpha:alpha];
...
- (void) setHex:(NSString *)hex {
    self.backgroundColor = [[HexColor alloc] initWithHex:hex alpha:1.0];
    label.text = hex;
...
- (void) fadeOut
{
    self.backgroundColor = [[HexColor alloc] initWithHex:self.hex alpha:0.1];
    
    label.textColor = [[HexColor alloc] initWithHex:@"000000" alpha:0.1];
}
@end
